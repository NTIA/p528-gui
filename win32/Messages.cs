...
namespace p528_gui
{
    ...
    {
        // warning text
        public const string ModelConsistencyWarning = "Caution: The P.528 model has returned a warning that the transition between diffraction and troposcatter might not be physically consistent.  Caution should be taken when using the results.";
        public const string LowFrequencyWarning = "Caution: The entered frequency is less than the lower limit specified in P.528.  Caution should be taken when using the results.";
